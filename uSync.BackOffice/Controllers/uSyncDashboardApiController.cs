...
namespace uSync.BackOffice.Controllers
{
    ...
    public class uSyncDashboardApiController : UmbracoAuthorizedApiController
    {
        ...
        public IEnumerable<uSyncAction> Report(uSyncOptions options)
        {
            ...
            var result = uSyncService.Report(settings.RootFolder, new SyncHandlerOptions()
            {
                Group = options.Group
            }, hubClient.Callbacks())
                .ToArray();
        ...
        private string GetLocal()
        {
            try
            {
                var localFile = Current.IOHelper.MapPath("~/App_Plugins/uSync8/addons.json");
        ...
        public AddOnInfo GetAddOns()
        {
            ...
            addOnInfo.Version = typeof(uSyncBackOffice).Assembly.GetName().Version.ToString()
