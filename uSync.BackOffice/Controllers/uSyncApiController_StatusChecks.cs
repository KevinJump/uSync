...
namespace uSync.BackOffice.Controllers
{
    ...
    public partial class uSyncDashboardApiController
    {
        ...
        private string GetLocal()
        {
            try
            {
                var localFile = Path.Combine(hostEnvironment.ContentRootPath, "App_Plugins\\uSync\\addons.json");
        ...
        public AddOnInfo GetAddOns()
        {
            ...
            addOnInfo.Version = typeof(global::uSync.BackOffice.uSyncBackOffice).Assembly.GetName().Version.ToString()
        ...
        public uSyncWarningMessage GetSyncWarnings(string action, uSyncOptions options)
        {
            ...
            if (this.uSyncConfig.Settings.ShowVersionCheckWarning && !uSyncService.CheckVersionFile(this.uSyncConfig.Settings.RootFolder))
            {
                message.Type = "info";
