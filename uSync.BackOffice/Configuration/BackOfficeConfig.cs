...
namespace uSync.BackOffice.Configuration
{
    ...
    public class uSyncConfig
    {
        ...
        {
            var configFolder = new DirectoryInfo(Current.HostingEnvironment.MapPathContentRoot(Constants.SystemDirectories.Config));
            settingsFile = Path.Combine(configFolder.FullName, uSyncBackOfficeConstants.ConfigFile);
        ...
        public uSyncSettings LoadSettings()
        {
            ...
            settings.RootFolder = Current.HostingEnvironment.MapPathContentRoot("~/uSync/v9");
        ...
        {
            var filePath = Current.IOHelper.MapPath(settingsFile);
