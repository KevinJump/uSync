...
namespace uSync8.Core.Serialization.Serializers
{
    ...
    public class MediaTypeSerializer : ContentTypeBaseSerializer<IMediaType>, ISyncNodeSerializer<IMediaType>
    {
        ...
        protected override SyncAttempt<XElement> SerializeCore(IMediaType item, SyncSerializerOptions options)
        {
            ...
            {
                // in a folder
                var folderNode = GetFolderNode(mediaTypeService.GetContainers(item)); //TODO: Cache this call.
                if (folderNode != null)
                    info.Add(folderNode);
            }
