...
> {
    ...
    renderLegacyFolder(folder: string | null | undefined) {
        return folder === undefined || folder === null
            ...
            : html`
                  <p>
                      uSync has found a legacy uSync folder at
                      <strong>${folder}</strong>.
                      <br />
                      Its likely that the content in it will need coverting in
                      someway
                  </p>
              `
    }
        ...
        return html`
            <div>
                ...
                <p>
                    ...
                    <a
                        href="https://github.com/Jumoo/uSyncMigrations"
                        target="_blank"
                        >uSync.Migrations</a
                    ><br />
                    <em
                        >(In the full uSync release conversion will happen
                        here.)</em
                    >
                </p>
            </div>
    ...
    renderCopy() {
        return html`
            ...
            <p>
                You can copy your ${this.data?.legacyFolder} folder to the
                ~/uSync/v14 folder<br />
                and run an import.
            </p>
            <p>
                If nothing needs converting, then everything should import.<br />
                but this is a beta release running on a beta release 🤞
            </p>
            <p>
                <strong
                    >Remove or rename the ${this.data?.legacyFolder} folder to
                    prevent this popup</strong
                >
            </p>
        `
    }
...
export const USYNC_LEGACY_MODAL = new UmbModalToken<
    SyncLegacyCheckResponse,
    string
>('usync.legacy.modal', {
    modal: {
