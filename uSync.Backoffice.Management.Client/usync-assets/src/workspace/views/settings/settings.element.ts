            ...
            <umb-body-layout>
                <div class="usync-settings-layout">
                    <div>
                        <uui-box
                            headline=${this.localize.term(
                                'uSyncSettings_settings',
                            )}
                        >
                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_importAtStartup',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_importAtStartupDesc',
                                )}
                                .value=${this.settings?.importAtStartup}
                            ></usync-setting-item>

                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_exportAtStartup',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_exportAtStartupDesc',
                                )}
                            ...
                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_exportOnSaveup',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_exportOnSaveDesc',
                                )}
                                .value=${this.settings?.exportOnSave}
                            ></usync-setting-item>

                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_uiEnabledGroups',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_uiEnabledGroupsDesc',
                                )}
                                .value=${this.settings?.uiEnabledGroups}
                            ></usync-setting-item>

                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_failOnMissingParent',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_failOnMissingParentDesc',
                                )}
                                .value=${this.settings?.failOnMissingParent}
                            ></usync-setting-item>
                        </uui-box>

                        <uui-box
                            headline=${this.localize.term(
                                'uSyncSettings_filesAndFolders',
                            )}
                        >
                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_rootSite',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_rootSiteDesc',
                                )}
                                .value=${this.settings?.isRootSite}
                            ></usync-setting-item>

                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_rootLocked',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_rootLockedDesc',
                                )}
                                .value=${this.settings?.lockRoot}
                            ></usync-setting-item>

                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_folders',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_foldersDesc',
                                )}
                    ...
                    <div>
                        <uui-box
                            headline=${this.localize.term(
                                'uSyncSettings_handlerDefaults',
                            )}
                        >
                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_flatStructure',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_flatStructureDesc',
                                )}
                            ...
                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_guidNames',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_guidNamesDesc',
                                )}
                                .value=${this.handlerSettings?.handlerDefaults
                                    ?.guidNames}
                            ></usync-setting-item>
                            ...
                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_handlerGroups',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_handlerGroupsDesc',
                                )}
                                .value=${this.handlerSettings?.handlerDefaults
                                    ?.group}
                            ></usync-setting-item>
                            ...
                            <usync-setting-item
                                .name=${this.localize.term(
                                    'uSyncSettings_disabledHandlers',
                                )}
                                .description=${this.localize.term(
                                    'uSyncSettings_disabledHandlersDesc',
                                )}
                                .value=${this.handlerSettings?.disabledHandlers}
                            ></usync-setting-item>
                        </uui-box>
                    </div>
                </div>
