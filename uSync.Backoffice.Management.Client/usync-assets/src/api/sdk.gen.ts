...
export class ActionsService {
    ...
    public static running<ThrowOnError extends boolean = true>(options?: Options<RunningData, ThrowOnError>) {
    ...
    public static status<ThrowOnError extends boolean = true>(options?: Options<StatusData, ThrowOnError>) {
