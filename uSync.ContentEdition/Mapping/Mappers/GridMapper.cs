...
namespace uSync.ContentEdition.Mapping.Mappers
{
    ...
    {
        public GridMapper(IEntityService entityService, SyncValueMapperFactory mapperFactory) : base(entityService, mapperFactory)
        { }
        ...
        private (string alias, IEnumerable<ISyncMapper> mapper) FindMappers(JObject editor)
        {
            ...
            var mappers = mapperFactory.GetMappers(alias);
            ...
            return (alias, mapperFactory.GetMappers(alias));
        }
