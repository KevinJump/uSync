...
using uSync.ContentEdition.Extensions;
...
namespace uSync.ContentEdition.Serializers
{
    ...
    public class ContentSerializer : ContentSerializerBase<IContent>, ISyncOptionsSerializer<IContent>
    {
       ...
       public ContentSerializer(
            ...
            : base(shortStringHelper, entityService, localizationService, relationService, logger, UmbracoObjectTypes.Document, syncMappers)
        {
