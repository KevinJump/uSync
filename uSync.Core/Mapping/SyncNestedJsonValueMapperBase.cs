...
namespace uSync.Core.Mapping
{
    ...
    public abstract class SyncNestedJsonValueMapperBase : SyncNestedValueMapperBase
    {
        ...
        public override string GetImportValue(string value, string editorAlias)
        {
            ...
            var jsonValue = value.GetJTokenFromObject();
            if (jsonValue == null) return value.ToString();
            return ProcessValues(jsonValue, editorAlias, GetImportProperties);
        }
        ...
        public override string GetExportValue(object value, string editorAlias)
        {
            ...
            return ProcessValues(jsonValue, editorAlias, GetExportProperties);
        }
        ...
        protected abstract string ProcessValues(JToken jsonValue, string editorAlias,
            Func<JObject, IContentType, JObject> GetPropertiesMethod);
    }
}
